...
import ru.aydarov.randroid.presentation.ui.adapters.CustomBindingAdapter
import java.io.File
import java.util.*
...
class ImageViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUrl = intent.getStringExtra(IMAGE_OPEN_KEY)
        mUrl?.let {
            CustomBindingAdapter.loadImage(ivShowView, it)
        }
    }
    ...
    private fun downloadImage() {
        val request = DownloadManager.Request(ImageUtil.getUri(mUrl))
        val filename = IMAGE_FILE_NAME + UUID.randomUUID()
    ...
    companion object {
        ...
        const val IMAGE_FILE_DIR = "/rAndroidDev/"
        const val IMAGE_OPEN_KEY = "It_phoyo"
